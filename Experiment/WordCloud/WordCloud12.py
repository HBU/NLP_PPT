...
import imageio
mk = imageio.imread("WordCloud/picture/chinamap.png")
...
f = open('WordCloud/words/三国演义.txt',encoding='utf-8')
txt = f.read()
...
w1.to_file('WordCloud/output12-positive.png')
w2.to_file('WordCloud/output12-negative.png')
print('词云生成完成')