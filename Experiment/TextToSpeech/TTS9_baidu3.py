# 失败：Open api request limit reached 。一次也没成功啊，没免费的测试了？
...
# 替换你的 API_KEY
API_KEY = 'YGWw9sGikBWpVnrDrWYgpLZm'

# 替换你的 SECRET_KEY
SECRET_KEY = 'Gi37Uk9G6MBHTLrcM2tn3e7RhXa9fhl0'

# 大姚的订单信息内容文本
TEXT = "北京首都国际机场T3航站楼 去往 东城区北三环东路36号喜来登大酒店(北京金隅店)"
